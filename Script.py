...
"""
    ...
    FILE_CAPTION = """<b><a href=https://t.me/AllMoviesHouse>{file_name} </a></b>
...
✨ ᴜᴘɪ ɪᴅ - <code>anewshkumarankitpanchalpro-1@okaxis</code>
...
<b><u>ʏᴏᴜ ᴀʀᴇ ɴᴏᴛ ᴠᴇʀɪꜰɪᴇᴅ ᴛᴏᴅᴀʏ, ᴘʟᴇᴀꜱᴇ ᴄʟɪᴄᴋ ᴏɴ ᴠᴇʀɪғʏ & ɢᴇᴛ ᴜɴʟɪᴍɪᴛᴇᴅ ᴀᴄᴄᴇꜱꜱ ғᴏʀ ᴛɪʟʟ ɴᴇxᴛ ᴠᴇʀɪғɪᴄᴀᴛɪᴏɴ</u>

#ᴠᴇʀɪꜰɪᴄᴀᴛɪᴏɴ</b>:- 1/3

आप आज ᴠᴇʀɪꜰɪᴇᴅ नहीं हैं, कृपया सत्यापित पर क्लिक करें और अगले ᴠᴇʀɪꜰɪᴄᴀᴛɪᴏɴ तक असीमित पहुंच प्राप्त करें
...
आप ᴠᴇʀɪꜰɪᴇᴅ नहीं हैं, कृपया सत्यापित पर क्लिक करें और असीमित पहुंच प्राप्त करें
...
💖 𝐔𝐏𝐈 𝐈𝐃 : <code>anewshkumarankitpanchalpro-1@okaxis</code>
"""
